...
**How to apply:** Read pages with the Read tool, one per call, per [reading-the-lrm-one-page-per-call](reading-the-lrm-one-page-per-call.md). Do not reach for `pypdf` even to read the outline: the LRM is read through the Read tool alone — see [locating-a-clause](locating-a-clause.md).
