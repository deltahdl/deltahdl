...
- [The 2017 edition on the shared drive](the-2017-edition-on-the-shared-drive.md) — `Standards/SystemVerilog/1800-2017.pdf` on the 10U Labs shared drive, read only to judge an sv-tests tag in its own edition.
