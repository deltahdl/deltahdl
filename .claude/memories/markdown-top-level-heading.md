...
description: Open every Markdown file with a top-level heading; markdownlint MD041 runs across every Markdown file in the checkout, dot-directories included.
metadata:
  type: project
---
