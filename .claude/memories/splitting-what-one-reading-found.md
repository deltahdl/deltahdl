---
name: splitting-what-one-reading-found
description: A scope that closes by finishing on its own is an issue of its own; avoid an issue that only closes when a whole family does.
metadata:
  type: feedback
---
...
One reading often turns up more than one scope. A scope that closes by finishing on its own is an issue of its own rather than a part of somebody else's.
