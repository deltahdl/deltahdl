...
| `7,17,27,37,47,57 * * * *` | `REMINDER: While any CI run for a pushed commit is in progress -- any workflow under .github/workflows, deltahdl.yml, scripts.yml, documentation.yml or another -- do nothing but wait for it: no diagnosis, no edits, no commits. A run is not the Workflow tool.` |
