...
Models follow "do X" more reliably than "don't do Y", because negation tends to surface the prohibited idea without suppressing it. [spawned-session-reached-for-pypdf](../incidents/spawned-session-reached-for-pypdf.md) is the session that showed it.
