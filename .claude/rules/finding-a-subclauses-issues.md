...
issues exist and the printed one is the parent: §34.5.28 is #2066, §34.5.28.1
is #2068 and §34.5.28.2 is #2070. The parent sorts first in
...
both #2073 and #2075 stood open. Whatever the reason, the search is not what
to trust here. `gh issue view <n>` on the numbers around the parent answers
directly, and the numbers run in the order the subclauses do.
