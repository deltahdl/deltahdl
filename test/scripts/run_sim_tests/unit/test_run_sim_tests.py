...
class TestCollectTests:
    ...
    def test_finds_sv_expected_pairs(self, rst, sim_test_tree):
    ...
    def test_ignores_sv_without_expected(self, rst, sim_test_tree):
    ...
    def test_returns_empty_list_when_no_pairs(self, rst, tmp_path):
...
class TestRunTest:
    ...
    def test_returns_true_on_matching_output(self, rst, tmp_path):
    ...
    def test_returns_false_on_mismatched_output(self, rst, tmp_path):
    ...
    def test_strips_trailing_newlines_before_comparing(self, rst, tmp_path):
    ...
    def test_returns_timeout_on_timeout_expired(self, rst, tmp_path):
