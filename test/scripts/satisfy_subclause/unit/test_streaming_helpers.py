...
def test_extract_session_id_returns_string(streaming) -> None:
...
def test_extract_session_id_non_system_event(streaming) -> None:
...
def test_extract_session_id_non_string_value(streaming) -> None:
...
def test_extract_session_id_missing_field(streaming) -> None:
...
def test_extract_tool_name_finds_tool_use(streaming) -> None:
...
def test_extract_tool_name_non_assistant_event(streaming) -> None:
    """Non-assistant events return None."""
    assert streaming.extract_tool_name({"type": "user"}) is None


def test_extract_tool_name_no_tool_use_block(streaming) -> None:
...
def test_extract_tool_name_null_message(streaming) -> None:
...
def test_describe_assistant_blocks_tool_use(streaming) -> None:
...
def test_describe_assistant_blocks_tool_use_missing_name(streaming) -> None:
...
def test_describe_assistant_blocks_thinking(streaming) -> None:
...
def test_describe_assistant_blocks_text(streaming) -> None:
...
def test_describe_assistant_blocks_empty(streaming) -> None:
    """An empty content list renders as '(empty)'."""
    event = {"type": "assistant", "message": {"content": []}}
    assert streaming.describe_assistant_blocks(event) == "(empty)"


def test_describe_assistant_blocks_null_content(streaming) -> None:
    """Null content renders as '(empty)'."""
    event = {"type": "assistant", "message": {"content": None}}
    assert streaming.describe_assistant_blocks(event) == "(empty)"


def test_describe_assistant_blocks_unknown_block_type(streaming) -> None:
...
def test_describe_user_blocks_tool_result_with_tool_name(streaming) -> None:
...
def test_describe_user_blocks_no_tool_result(streaming) -> None:
...
def test_describe_result_event_success(streaming) -> None:
...
def test_describe_result_event_success_default_subtype(streaming) -> None:
...
def test_describe_result_event_is_error(streaming) -> None:
...
def test_describe_result_event_is_error_default_subtype(streaming) -> None:
...
def test_describe_event_assistant(streaming) -> None:
...
def test_describe_event_user(streaming) -> None:
...
def test_describe_event_system(streaming) -> None:
...
def test_describe_event_system_no_subtype(streaming) -> None:
...
def test_describe_event_result(streaming) -> None:
...
def test_describe_event_unknown_type(streaming) -> None:
    """Unknown event types render their type string."""
    assert streaming.describe_event({"type": "weird"}, None) == "weird"


def test_describe_event_missing_type(streaming) -> None:
