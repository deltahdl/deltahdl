...
// The vpi_put_value_array() tests read back element values that the routine
// wrote into a static unpacked array built by the shared base fixture.
using VpiPutValueArraySim = VpiValueArraySimBase;
