...
TEST(Lexer, KeywordVersion_1364_1995_LaterKeywordsNotRecognized) {
  ...
  EXPECT_FALSE(LookupKeyword("cell", KeywordVersion::kVer13641995).has_value());
  EXPECT_FALSE(
  ...
  EXPECT_FALSE(LookupKeyword("bit", KeywordVersion::kVer13641995).has_value());
  EXPECT_FALSE(
