...
TEST(DeclarationListParsing, ListOfVariableIdentifiersSingle) {
...
TEST(DeclarationListParsing, ListOfVariablePortIdentifiersWithDim) {
...
TEST(DeclarationListParsing, ListOfVariableIdentifiersMultipleAnsi) {
  auto r = ParseWithPreprocessor(
...
TEST(DeclarationListParsing, ListOfVariableIdentifiersWithDim) {
...
TEST(DeclarationListParsing, ListOfVariablePortIdentifiersMultipleAnsi) {
  auto r = ParseWithPreprocessor(
