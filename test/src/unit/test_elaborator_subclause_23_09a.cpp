// Tests for the §23.9 scope rules: one identifier declares one item within a
// scope, and a direct reference searches upward from the scope it stands in
// until a module boundary.
//
