...
TEST(ConditionalSyntaxParsing, UniqueIfQualifier) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    unique if (a) x = 1;\n"
...
TEST(ConditionalSyntaxParsing, Unique0IfQualifier) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    unique0 if (a) x = 1;\n"
...
TEST(ConditionalSyntaxParsing, PriorityIfQualifier) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    priority if (a) x = 1;\n"
...
TEST(ConditionalSyntaxParsing, ElseWithoutIfIsError) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    else x = 1;\n"
