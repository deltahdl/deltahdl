...
// encryption envelope encloses for the expression and keeps the name beside the
// region rather than among the lines that are about to stop being readable, and
// src/preprocessor/protect_processing.cpp holds the line carrying it back from
// the text the block records.
