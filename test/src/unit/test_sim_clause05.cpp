...
// ===========================================================================
// §5.6.2 Keywords — simulation-level tests
// ===========================================================================

TEST(SimCh5, KeywordDefinesConstruct) {
...
TEST(SimCh5, EscapedKeywordCoexistsWithKeyword) {
...
TEST(SimCh5, KeywordLowercaseOnly) {
...
// ===========================================================================
// §5.6.3 System tasks and system functions — simulation-level tests
// ===========================================================================

TEST(SimCh5, SystemTaskDoesNotConsumeTime) {
...
TEST(SimCh5, SystemFunctionReturnsValue) {
...
TEST(SimCh5, SystemFunctionInExpression) {
...
// ===========================================================================
// §5.6.4 Compiler directives — simulation-level tests
// ===========================================================================
...
TEST(SimCh5, DefineMacroAffectsSimulation) {
...
TEST(SimCh5, DirectivePersistsInCompilationUnit) {
