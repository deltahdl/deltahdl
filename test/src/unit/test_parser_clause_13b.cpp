...
TEST(ParserSection13, Sec13_8_VirtualClassStaticTask) {
  auto r = Parse("virtual class C#(parameter W = 8);\n"
...
TEST(ParserSection13, Sec13_8_MultipleParamsWithDefaults) {
  auto r = Parse("virtual class Codec#(parameter IN_W = 8,\n"
...
TEST(ParserSection13, Sec13_8_ThreeParams) {
  auto r = Parse("virtual class Xform#(parameter IN_W = 8,\n"
...
TEST(ParserSection13, Sec13_8_MixedStaticFuncAndTask) {
  auto r = Parse("virtual class Utils#(parameter N = 4);\n"
...
TEST(ParserSection13, Sec13_8_TypeParameter) {
  EXPECT_TRUE(ParseOk("virtual class Converter#(parameter type T = int);\n"
...
TEST(ParserSection13, Sec13_8_StaticMethodNoArgs) {
  auto r = Parse("virtual class Constants#(parameter N = 32);\n"
...
TEST(ParserSection13, Sec13_8_MultiArgParameterizedWidth) {
  EXPECT_TRUE(ParseOk("virtual class Arith#(parameter W = 16);\n"
...
TEST(ParserSection13, Sec13_8_NoDefaultParam) {
  auto r =
      Parse("virtual class Shifter#(parameter int AMOUNT);\n"
...
TEST(ParserSection13, Sec13_8_ReturnTypeUsesParam) {
  EXPECT_TRUE(ParseOk("virtual class Pack#(parameter W = 8);\n"
...
TEST(ParserSection13, Sec13_8_MethodsCallEachOther) {
  EXPECT_TRUE(ParseOk("virtual class Math#(parameter W = 32);\n"
...
TEST(ParserSection13, Sec13_8_OnlyStaticTask) {
  auto r = Parse("virtual class Printer#(parameter int ID = 0);\n"
                 "  static task print();\n"
                 "    $display(\"ID=%0d\", ID);\n"
                 "  endtask\n"
                 "endclass\n");
