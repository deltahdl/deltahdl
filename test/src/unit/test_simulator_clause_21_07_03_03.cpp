...
// Exercises the $dumpportsall system task end to end so the checkpoint semantics
// of §21.7.3.3 are observed as the production task path applies them. The
// extended VCD port checkpoint reuses the inherited 4-state checkpoint machinery
// (§21.7.1.4).
