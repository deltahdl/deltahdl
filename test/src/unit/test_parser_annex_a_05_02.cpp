...
TEST(ParserAnnexA052, NonAnsiPortList_TwoInputs) {
  auto r = Parse("primitive and_gate(out, a, b);\n"
                 "  output out;\n"
                 "  input a, b;\n"
                 "  table\n"
                 "    0 0 : 0;\n"
...
TEST(ParserAnnexA052, NonAnsiPortList_FiveInputs) {
  auto r = Parse("primitive gate5(out, a, b, c, d, e);\n"
                 "  output out;\n"
                 "  input a, b, c, d, e;\n"
                 "  table\n"
                 "    0 0 0 0 0 : 0;\n"
...
TEST(ParserAnnexA052, AnsiPortList_SingleInput) {
  auto r = Parse("primitive inv(output out, input a);\n"
                 "  table\n"
                 "    0 : 1;\n"
                 "    1 : 0;\n"
                 "  endtable\n"
...
TEST(ParserAnnexA052, AnsiPortList_MixedInputKeyword) {
  auto r = Parse("primitive gate(output out, input a, input b, c);\n"
                 "  table\n"
                 "    0 0 0 : 0;\n"
                 "    1 1 1 : 1;\n"
                 "  endtable\n"
...
TEST(ParserAnnexA052, PortDecl_OutputPlain) {
  auto r = Parse("primitive inv(out, a);\n"
                 "  output out;\n"
                 "  input a;\n"
                 "  table\n"
                 "    0 : 1;\n"
...
TEST(ParserAnnexA052, PortDecl_InputList) {
  auto r = Parse("primitive gate(out, a, b, c);\n"
                 "  output out;\n"
                 "  input a, b, c;\n"
                 "  table\n"
                 "    0 0 0 : 0;\n"
...
TEST(ParserAnnexA052, OutputDeclAnsi_RegInitZero) {
  auto r = Parse("primitive dff(output reg q = 1'b0, input d, input clk);\n"
                 "  table\n"
                 "    0 r : ? : 0;\n"
                 "    1 r : ? : 1;\n"
                 "  endtable\n"
...
TEST(ParserAnnexA052, OutputDeclAnsi_RegInitOne) {
  auto r = Parse("primitive dff(output reg q = 1'b1, input d, input clk);\n"
                 "  table\n"
                 "    0 r : ? : 0;\n"
                 "    1 r : ? : 1;\n"
                 "  endtable\n"
...
TEST(ParserAnnexA052, OutputDeclAnsi_RegInitX) {
  auto r = Parse("primitive dff(output reg q = 1'bx, input d, input clk);\n"
                 "  table\n"
                 "    0 r : ? : 0;\n"
                 "    1 r : ? : 1;\n"
                 "  endtable\n"
...
TEST(ParserAnnexA052, InputDecl_MultipleIds) {
  auto r = Parse("primitive gate(out, a, b, c, d);\n"
                 "  output out;\n"
                 "  input a, b, c, d;\n"
                 "  table\n"
                 "    0 0 0 0 : 0;\n"
...
TEST(ParserAnnexA052, RegDecl_AfterOutput) {
  auto r = Parse("primitive latch(q, d, en);\n"
                 "  output q;\n"
                 "  reg q;\n"
                 "  input d, en;\n"
                 "  table\n"
...
TEST(ParserAnnexA052, SimPortLevelInit) {
  auto r = Parse("primitive latch(output reg q = 1'b0, input d, input en);\n"
                 "  table\n"
                 "    ? 0 : ? : -;\n"
                 "    0 1 : ? : 0;\n"
                 "    1 1 : ? : 1;\n"
