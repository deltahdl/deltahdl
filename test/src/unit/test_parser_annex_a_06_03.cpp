...
TEST(BlockStatementSyntaxParsing, NestedBeginEndTwoLevels) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    a = 0;\n"
...
TEST(BlockStatementSyntaxParsing, DeeplyNestedBeginEndThreeLevels) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    begin\n"
...
TEST(BlockStatementSyntaxParsing, NestedForkInsideFork) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    fork\n"
...
TEST(BlockStatementSyntaxParsing, ForkInBeginInFork) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    fork\n"
