...
TEST(ModuleInstantiationGrammar, OrderedPortConnectionsElaborate) {
  auto r = Parse(
      "module top;\n"
      "  sub u1 (a, b, c);\n"
      "endmodule\n");
...
TEST(ModuleInstantiationGrammar, PortConnectionPositional) {
  auto r = Parse(
      "module top;\n"
      "  sub u1(a, b, c);\n"
      "endmodule\n");
...
TEST(ModuleInstantiationGrammar, PositionalPortConnections) {
  auto r = Parse(
      "module top;\n"
      "  sub u1 (a, b, c);\n"
      "endmodule\n");
...
TEST(ModuleInstantiationGrammar, ModuleInstNamed) {
...
TEST(ModuleInstantiationGrammar, NamedPortConnectionsElaborate) {
  auto r = Parse(
      "module top;\n"
...
TEST(ModuleInstantiationGrammar, ModuleInstBasic) {
  auto r = Parse(
      "module top;\n"
      "  sub u1(.a(w1), .b(w2));\n"
      "endmodule\n");
...
TEST(ModuleInstantiationGrammar, PortConnectionNamed) {
  auto r = Parse(
      "module top;\n"
...
TEST(ModuleInstantiationGrammar, PortConnectionEmptyNamed) {
  auto r = Parse(
      "module top;\n"
...
TEST(ModuleInstantiationGrammar, SimpleModuleInstance) {
  auto r = Parse(
      "module top;\n"
      "  sub u1 (.a(x), .b(y));\n"
      "endmodule\n");
...
TEST(ModuleInstantiationGrammar, PortConnectionRulesNamedMultiple) {
  auto r = Parse(
      "module top;\n"
...
TEST(ModuleInstantiationGrammar, NamedPortConnectionsMultiModule) {
  auto r = Parse(
