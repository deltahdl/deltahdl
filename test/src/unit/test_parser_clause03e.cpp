...
static ParseResult3e Parse(const std::string& src) {
  ParseResult3e result;
...
// --- §3.14.2.3 Tests: Precedence of timeunit, timeprecision, and `timescale
// ---
...
// --- §3.14.3 Tests: Simulation time unit (global time precision) ---
