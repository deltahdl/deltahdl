...
enum class GateType : uint8_t {
  ...
  kTran, kRtran, kTranif0, kTranif1, kRtranif0, kRtranif1,
  kCmos, kRcmos,
  kPullup, kPulldown,
};

enum class StrengthLvl : uint8_t {
  kHighz = 0, kSmall, kMedium, kWeak, kLarge, kPull, kStrong, kSupply
};
...
TEST(GateDecl, PullupNoDelays) {
  EXPECT_EQ(MaxDelays(GateType::kPullup), 0u);
}
