...
TEST(CasezSyntaxParsing, CasezStatement) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    casez (sel)\n"
...
TEST(CasezSyntaxParsing, CasezWithQuestionMark) {
  auto r = Parse(
      "module t;\n"
      "  initial begin\n"
      "    casez (ir)\n"
...
TEST(CasezSyntaxParsing, AlwaysLatchCasezStatement) {
  auto r = Parse(
      "module m;\n"
      "  logic [3:0] sel, q, a, b;\n"
      "  always_latch\n"
...
TEST(CasezSyntaxParsing, CasezStatement2Items) {
  auto r = Parse(
      "module t;\n"
      "  initial begin\n"
      "    casez (sel)\n"
...
TEST(CasezSyntaxParsing, AlwaysCombCasezStatement) {
  auto r = Parse(
      "module m;\n"
      "  logic [3:0] req;\n"
      "  logic [1:0] grant;\n"
...
TEST(CasezSyntaxParsing, CasezEmptyNoItems) {
  auto r = Parse(
      "module m;\n"
      "  initial begin\n"
      "    casez (sel)\n"
