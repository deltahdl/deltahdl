...
// test_lexer_clause_33_04_01.cpp, which also carries the §5.6 case-sensitivity
// and maximal-munch rules that decide whether a spelling is one of these
// keywords at all.) Each test confirms the spelling is lexed as its
// reserved-word token rather than a plain identifier. Syntax 33-4 restates
