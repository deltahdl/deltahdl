...
// statement that reads it (the NBA region of §4.4.2.4 follows the Active region
// of §4.4.2.2) -- so seen is 50 then 500. The module reads both through the
// handle at time 3, where w is 9.
