...
TEST(SimCh502, LexicalTokenCommentsDoNotAffectSimulation) {
  ...
  // simulation behavior.
  auto result = RunAndGet("module /* block */ t; // line\n"
...
TEST(SimCh502, LexicalTokenBlockCommentAsSeparator) {
  ...
  auto result =
      RunAndGet("module/**/t;logic/**/[7:0]/**/result;initial/**/result=8'd66;"
                "endmodule",
                "result");
...
TEST(SimCh502, LexicalTokenLineCommentTerminatesAtNewline) {
  ...
  auto result = RunAndGet("module t; // this is a comment\n"
...
TEST(SimCh502, LexicalTokenFreeFormatAlwaysComb) {
  ...
  auto result = RunAndGet("module t; logic [7:0] a, result;\n"
                          "initial a = 8'd5;\n"
                          "always_comb result\n=\na\n+\n8'd10\n;\nendmodule\n",
                          "result");
