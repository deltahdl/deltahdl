...
def build_dependency_prompt(subclause: str, lrm: str) -> str:
    ...
    return (
        ...
        " those.\n\n"
        "List leaf subclauses only — the most specific identifier"
        " whose machinery the rule needs, with no further sub-numbering"
        " under it in the LRM. For example, list §33.4.1.5, never the"
        " containing §33.4.1 or §33 if §33.4.1.5 is itself a leaf.\n\n"
