...
const std::unordered_map<std::string_view, KeywordEntry>& KeywordMap() {
  static const std::unordered_map<std::string_view, KeywordEntry> map = {
      ...
      {"pulsestyle_onevent",
       {TokenKind::kKwPulsestyleOnevent, V::kVer13642001}},
...
const std::unordered_map<std::string_view, KeywordVersion>& VersionMap() {
  static const std::unordered_map<std::string_view, KeywordVersion> map = {
