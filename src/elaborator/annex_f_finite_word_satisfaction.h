...
// §F.5.3.2: classify the finite word w against the assertion A into the verdict
// a tool should return. Strong satisfaction implies neutral satisfaction, which
