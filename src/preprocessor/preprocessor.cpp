...
static std::string_view after_directive(std::string_view line,
                                        std::string_view dir) {
  auto trimmed = trim(line);
...
std::string Preprocessor::process_source(std::string_view src, uint32_t file_id,
                                         int depth) {
...
bool Preprocessor::process_directive(std::string_view line, uint32_t file_id,
...
void Preprocessor::handle_include(std::string_view filename_raw, SourceLoc loc,
...
std::string Preprocessor::expand_macro(const MacroDef& macro,
