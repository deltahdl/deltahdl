...
// §34.5.10.1, §34.5.11.1, §34.5.12.1, §34.5.16.1, §34.5.17.1 and §34.5.18.1
// are the ones whose subclauses have been taken; the rest of the table's
// `= <string>` keywords join them as theirs are.
