...
void NetlistWriter::write(const AigGraph& graph, NetlistFormat fmt,
...
void NetlistWriter::write_verilog(const AigGraph& /*graph*/,
                                  const std::string& /*filename*/) {
...
void NetlistWriter::write_blif(const AigGraph& /*graph*/,
                               const std::string& /*filename*/) {
...
void NetlistWriter::write_json(const AigGraph& /*graph*/,
                               const std::string& /*filename*/) {
...
void NetlistWriter::write_edif(const AigGraph& /*graph*/,
                               const std::string& /*filename*/) {
