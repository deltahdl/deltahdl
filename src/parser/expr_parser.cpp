...
static BpPair infix_bp(TokenKind kind) {
    ...
    case TokenKind::PipeEqGt:      return {1, 2};
    case TokenKind::PipePipe:       return {3, 4};
    case TokenKind::AmpAmp:        return {5, 6};
    case TokenKind::Pipe:          return {7, 8};
    case TokenKind::Caret:
    case TokenKind::CaretTilde:
    case TokenKind::TildeCaret:    return {9, 10};
    case TokenKind::Amp:           return {11, 12};
    case TokenKind::EqEq:
    case TokenKind::BangEq:
    case TokenKind::EqEqEq:
    case TokenKind::BangEqEq:
    case TokenKind::EqEqQuestion:
    case TokenKind::BangEqQuestion: return {13, 14};
    case TokenKind::Lt:
    case TokenKind::Gt:
    case TokenKind::LtEq:
    case TokenKind::GtEq:          return {15, 16};
    case TokenKind::LtLt:
    case TokenKind::GtGt:
    case TokenKind::LtLtLt:
    case TokenKind::GtGtGt:        return {17, 18};
    case TokenKind::Plus:
    case TokenKind::Minus:         return {19, 20};
    case TokenKind::Star:
    case TokenKind::Slash:
    case TokenKind::Percent:       return {21, 22};
    case TokenKind::Power:         return {24, 23}; // right-assoc
    default:                        return {-1, -1};
    }
}
...
Expr* Parser::parse_primary_expr() {
    ...
    if (tok.kind == TokenKind::IntLiteral || tok.kind == TokenKind::UnbasedUnsizedLiteral) {
        consume();
