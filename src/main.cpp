...
std::string preprocess_sources(const CliOptions& opts, delta::SourceManager& src_mgr,
...
delta::CompilationUnit* parse_source(std::string& source, delta::SourceManager& src_mgr,
...
int run_simulation(const CliOptions& opts, delta::CompilationUnit* cu, delta::DiagEngine& diag,
                   delta::Arena& arena) {
