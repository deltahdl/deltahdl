...
public:
    ...
    void add_signal(std::string_view scope, std::string_view name, uint32_t width);
    void write_header();
...
private:
    ...
    void write_vector_change(const Logic4Vec& value, uint32_t width, const std::string& id_str);
